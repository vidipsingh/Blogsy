...
const BlogInteraction = () => {
    ...
    useEffect(() => {
        ...
        if(access_token ){
            //make req to server to get the like info
        ...
        <Toaster />
            ...
            <div className="flex gap-6 justify-between">
                ...
                <div className="flex gap-3 items-center">
                        ...
                        <p className="textxl text-dark-grey">{ total_likes }</p>
                        ...
                        <p className="textxl text-dark-grey">{ total_comments }</p>
                </div>
                ...
                <div className="flex gap-6 items-center">
                    ...
                    <Link to={`https://twitter.com/intent/tweet/tweet?text=Read ${title}&url=${location.href}`}><i className="fi fi-brands-twitter text-xl hover:text-twitter "></i></Link>
                </div>
