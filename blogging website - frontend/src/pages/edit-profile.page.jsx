...
const EditProfile = () => {
    ...
    useEffect(() => {
        ...
        if(access_token){
            axios.post('http://localhost:3000/get-profile', { username: userAuth.username })
            .then(({ data }) => {
                setProfile(data);
                setLoading(false);
            })
    ...
    const handleImageUpload = (e) => {
        ...
        if(updatedProfileImg){
            ...
            .then(url => {
                ...
                if(url){
                    axios.post('http://localhost:3000/update-profile-img', { url }, {
                        headers: {
                    ...
                    .then(({ data }) => {
                        ...
                        e.target.removeAtrribute("disable");
