...
const PageNotFound = () => {
    ...
    return (
        <section className="h-cover relative p-10 flex flex-col items-center gap-20 text-center">
            <img src={ theme == "light" ? darkPageNotFoundImg : lightPageNotFoundImg } alt="" className='select-none border-2 border-grey w-72 aspect-square object-cover rounded' />
            ...
            <div className='mt-auto'>
                <img src={ theme == "light" ? darkFullLogo : lightFullLogo } alt="" className='h-10 object-contain block mx-auto select-none' />
